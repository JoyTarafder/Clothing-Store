...
<body class="bg-gray-50">
    ...
    <nav class="bg-white shadow-md">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="space-x-4">
                ...
                <a href="./returnpolicy.php" class="text-gray-600 hover:text-gray-800">Return Policy</a>
            </div>
        </div>
    </nav>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-gray-800">Return Policy</h1>
            <p class="text-lg text-gray-600 mt-4">Learn about our return process and policies.</p>
        </div>
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Return Period</h2>
            <p class="text-gray-600 mb-4">
                You can return any item purchased from our store within 30 days of the delivery date. The item must be in its original condition, unused, and with all tags attached.
            </p>
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Return Process</h2>
            <p class="text-gray-600 mb-4">
                To initiate a return, please contact our customer service team at support@clothstore.com with your order number and reason for return. Our team will provide you with a return authorization and instructions on how to send the item back to us.
            </p>
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Refunds</h2>
            <p class="text-gray-600 mb-4">
                Once we receive and inspect the returned item, we will process your refund within 7-10 business days. The refund will be issued to the original payment method used for the purchase. Please note that shipping charges are non-refundable.
            </p>
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Exchanges</h2>
            <p class="text-gray-600 mb-4">
                If you would like to exchange an item for a different size or color, please follow the return process and place a new order for the desired item. We will process the return and refund for the original item as per our return policy.
            </p>
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Contact Us</h2>
            <p class="text-gray-600">
                If you have any questions or concerns about our return policy, please contact us at support@clothstore.com.
            </p>
        </div>
    </div>
